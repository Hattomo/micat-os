...
// make 32 address for config_address
...
// add device to devices[] & incriment num_device
...
Error ScanAllBus() {
    ...
    for (uint8_t function = 1; function < 0; ++function) {
